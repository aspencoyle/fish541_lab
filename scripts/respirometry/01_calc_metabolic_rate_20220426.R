...
getwd(); setwd('..'); setwd('..') setwd('constraints/20220426'); getwd()
...
getwd(); setwd('..'); setwd('..'); setwd('plots/20220426'); getwd()
...
## Input constraints
setwd('..'); getwd(); setwd('..'); getwd(); setwd('constraints/20220426'); getwd()
...
write.xlsx(x=oxy_hr,file="20220426.xlsx", sheetName = "sheet1", col.names = TRUE, row.names = TRUE, append = FALSE)
